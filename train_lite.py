...
if __name__ == '__main__':
    ...
    for alpha in alphas:
        ...
        models_folder = para.home_dir + 'misc/' + para.dataset + '/' + para.model_type + str(alpha)
        if not os.path.exists(models_folder):
            os.makedirs(models_folder, mode=0o777)

        models_log_folder = para.home_dir + 'misc/' + para.dataset + '/' + para.model_type + str(alpha) + '/tensorboard_log'
        ...
        plt.savefig(para.home_dir + 'misc/' + para.dataset + '/' + para.model_type + str(alpha) + '/accuracy.png')
        plt.show()
        plt.clf()
        plt.cla()
        plt.close()
        ...
        plt.savefig(para.home_dir + 'misc/' + para.dataset + '/' + para.model_type + str(alpha) + '/loss.png')
        plt.show()
